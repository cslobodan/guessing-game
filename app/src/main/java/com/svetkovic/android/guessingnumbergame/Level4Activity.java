...
public class Level4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        breadcrumbs.setImageResource(R.drawable.flow4);

        TextView initialText = findViewById(R.id.initial_text);
        initialText.setText(R.string.info_text_one_l4);
        //********menja se pri promeni nivoa********
    ...
    public void gameStart(View v){
        ...
        //********menja se pri promeni nivoa********
        String invalidMessage = this.getString(R.string.invalidMessage_l4) + "!";
        //********menja se pri promeni nivoa********
        ...
        if(hasWon){
            ...
            resetDugme.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //********menja se pri promeni nivoa********
                    Intent i = new Intent(Level4Activity.this, Level5Activity.class);
                    //********menja se pri promeni nivoa********
        ...
        if(kontrola == 0) {
            ...
            resetDugme.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //********menja se pri promeni nivoa********
                    Intent i = new Intent(Level4Activity.this, MainActivity.class);
                    //********menja se pri promeni nivoa********
