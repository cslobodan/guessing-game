...
public class Level2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        breadcrumbs.setImageResource(R.drawable.flow2);

        TextView initialText = findViewById(R.id.initial_text);
        initialText.setText(R.string.info_text_one_l2);
        //********menja se pri promeni nivoa********
    ...
    public void gameStart(View v){
        ...
        //********menja se pri promeni nivoa********
        String invalidMessage = this.getString(R.string.invalidMessage_l2) + "!";
        //********menja se pri promeni nivoa********
        ...
        if(kontrola == 0) {
            ...
            resetDugme.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //********menja se pri promeni nivoa********
                    Intent i = new Intent(Level2Activity.this, MainActivity.class);
                    //********menja se pri promeni nivoa********
