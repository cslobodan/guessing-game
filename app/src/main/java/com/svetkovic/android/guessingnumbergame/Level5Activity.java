...
public class Level5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        breadcrumbs.setImageResource(R.drawable.flow5);

        TextView initialText = findViewById(R.id.initial_text);
        initialText.setText(R.string.info_text_one_l5);
        //********menja se pri promeni nivoa********
    ...
    public void gameStart(View v){
        ...
        String winMessage = this.getString(R.string.winMessage3);
        ...
        //********menja se pri promeni nivoa********
        String invalidMessage = this.getString(R.string.invalidMessage_l5) + "!";
        //********menja se pri promeni nivoa********
        ...
        if(hasWon){
            ...
            emoticon.setImageResource(R.drawable.win);
            ...
            resetDugme.setText(R.string.game_finished);
            ...
            resetDugme.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //********menja se pri promeni nivoa********
                    Intent i = new Intent(Level5Activity.this, MainActivity.class);
                    //********menja se pri promeni nivoa********
